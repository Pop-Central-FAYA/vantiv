...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_highcharts_vue__ = __webpack_require__(177);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vee_validate__ = __webpack_require__(178);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_vuetify__ = __webpack_require__(179);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_vuetify_dist_vuetify_min_css__ = __webpack_require__(180);
...
// MEDIA PLANNING
Vue.component('media-plan-suggestion-table', __webpack_require__(182));
Vue.component('media-plan-suggestion-graph', __webpack_require__(185));
Vue.component('media-plan-suggestion-selected', __webpack_require__(188));
Vue.component('media-plan-suggestion-filter', __webpack_require__(191));
Vue.component('media-plan-footer-nav', __webpack_require__(194));
Vue.component('media-plan-suggestions', __webpack_require__(197));
Vue.component('media-plan-create-campaign', __webpack_require__(200));

// ASSET MANAGEMENT
Vue.component('media-asset-upload', __webpack_require__(203));
Vue.component('media-asset-display', __webpack_require__(209));
//Schedule
Vue.component('vue-cal-weekly-schedule', __webpack_require__(212));
Vue.component('ad-schedule-table', __webpack_require__(220));
Vue.component('ad-hour-table', __webpack_require__(223));
Vue.component('ad-break-table', __webpack_require__(226));
//mpo list
Vue.component('campaign-mpos-list', __webpack_require__(229));
Vue.component('mpo-slot-list', __webpack_require__(232));
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_highcharts__ = __webpack_require__(5);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(215)("5ed1332a", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
var render = function() {
  ...
  return _c("table", [
    ...
    _c(
      "tbody",
      _vm._l(_vm.mpos, function(mpo) {
        return _c("tr", { key: mpo.id }, [
          _c("td", [_vm._v(_vm._s(mpo.station))]),
          _vm._v(" "),
          _c("td", [_vm._v(_vm._s(_vm.format_audience(mpo.budget)))]),
          _vm._v(" "),
          _c("td", [_vm._v(_vm._s(mpo.ad_slots))]),
          _vm._v(" "),
          _c("td", [_vm._v(_vm._s(mpo.status))]),
          _vm._v(" "),
          _c("td", [
            _c(
              "button",
