...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_highcharts__ = __webpack_require__(6);
...
Vue.component('media-asset-display', __webpack_require__(211));
Vue.component('media-asset-delete', __webpack_require__(214));
Vue.component('media-asset-play-video', __webpack_require__(217));

//Schedule
Vue.component('vue-cal-weekly-schedule', __webpack_require__(222));
Vue.component('ad-schedule-table', __webpack_require__(228));
Vue.component('ad-hour-table', __webpack_require__(231));
Vue.component('ad-break-table', __webpack_require__(234));
//mpo list
Vue.component('campaign-mpos-list', __webpack_require__(237));
Vue.component('mpo-slot-list', __webpack_require__(242));
Vue.component('mpo-file-manager', __webpack_require__(245));
Vue.component('file-modal', __webpack_require__(248));
Vue.component('delete-slots-modal', __webpack_require__(253));
Vue.component('edit-slots-modal', __webpack_require__(262));
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(4)("2e56c637", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
            ...
            fn: function(props) {
              return [
                ...
                _c(
                  ...
                  [
                    _c("media-asset-delete", {
                      attrs: { "asset-id": props.item.id }
                    })
                  ],
                  1
                )
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(4)("56173b72", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(4)("5ed1332a", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(4)("624153f2", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        ...
        Event.$on('updated-adslots-component', function (adslot) {
            self.groupedAdslots = adslot;
        });
    },
    mounted: function mounted() {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(4)("5b5f5663", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(4)("f807979c", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(4)("7260adb3", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
                        ...
                        switch (_context.prev = _context.next) {
                            ...
                            case 5:
                                ...
                                axios({
                                    ...
                                    if (res.data.status === 'success') {
                                        _this.sweet_alert(res.data.message, 'success');
                                        Event.$emit('updated-adslots-component', _this.groupAdslotByProgram(res.data.data));
