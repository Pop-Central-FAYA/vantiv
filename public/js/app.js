...
// ASSET MANAGEMENT
Vue.component('media-asset-upload', __webpack_require__(200));
Vue.component('media-asset-display', __webpack_require__(206));
//Schedule
Vue.component('vue-cal-weekly-schedule', __webpack_require__(209));
Vue.component('ad-schedule-table', __webpack_require__(217));
Vue.component('ad-hour-table', __webpack_require__(220));
Vue.component('ad-break-table', __webpack_require__(223));
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      _c("v-data-table", {
        staticClass: "custom-vue-table",
        attrs: { headers: _vm.headers, items: _vm.assets, search: _vm.search },
        scopedSlots: _vm._u([
          {
            key: "items",
            fn: function(props) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(212)("5ed1332a", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
