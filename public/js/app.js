...
var render = function() {
  ...
  return _c("table", [
    ...
    _c(
      "tbody",
      _vm._l(_vm.adslots, function(adslot) {
        return _c("tr", { key: adslot.id }, [
          _c("td", [_vm._v(_vm._s(adslot.day))]),
          _vm._v(" "),
          _c("td", [_vm._v(_vm._s(adslot.program))]),
          _vm._v(" "),
          _c("td", [_vm._v(_vm._s(adslot.time_belt_start_time))])
        ])
      }),
      0
    )
