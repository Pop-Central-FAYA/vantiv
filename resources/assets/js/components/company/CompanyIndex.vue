                ...
                <v-flex xs12 sm8 md8>
                    ...
                    <v-layout wrap>
                        <v-flex xs12 sm12 md12 v-show="showProgressBar">
                            ...
                            <v-progress-linear v-model="uploadPercentage" color="green"></v-progress-linear>
                        </v-flex>
                    </v-layout>
    ...
    export default {
        ...
        created() {    
         ...
         methods: {   
            ...
            upload_file: async function(file, presignedUrl) {
                this.showProgressBar = true;
                this.uploadPercentage = 0;
                this.currentUploadTitle = "Uploading logo";
