                            ...
                            <v-layout wrap>
                                <v-flex xs12 sm6 md6>
                                    <v-text-field  required :clearable="true"   :label="'First Name'" 
                                                :placeholder="'First Name'" :hint="'Enter your first name'" 
                                                :solo="true" :single-line="true"
                                                v-validate="'required|max:255'"
                                                :error-messages="errors.collect('first_name')"
                                                v-model="user.firstname" data-vv-name="first_name">
                                    </v-text-field>
                                </v-flex>
                                <v-flex xs12 sm6 md6>
                                    <v-text-field  required :clearable="true"   :label="'Last Name'" 
                                                :placeholder="'Last Name'" :hint="'Enter your last name'" 
                                                :solo="true" :single-line="true"
                                                v-validate="'required|max:255'"
                                                :error-messages="errors.collect('last_name')"
                                                v-model="user.lastname" data-vv-name="last_name">
                                    </v-text-field>
                                </v-flex>
                            </v-layout>
                            ...
                            <v-layout wrap>
                                <v-flex xs12 sm6 md6>
                                    <v-text-field required  :label="'Email'" 
                                                :placeholder="'Email'" :hint="'Enter email'" 
                                                :solo="true" :single-line="true"
                                                v-validate="'required|email'"
                                                :error-messages="errors.collect('email')"
                                                v-model="user.email" data-vv-name="email"
                                                disabled>
                                    </v-text-field>
                                </v-flex>
                                <v-flex xs12 sm6 md6>
                                    <v-text-field  required :clearable="true"   :label="'Phone Number'" 
                                                ...
                                                v-model="user.phone_number" data-vv-name="phone_number">
                                    </v-text-field>
                                </v-flex>
                            </v-layout>
                            <v-layout wrap>
...
<script>
    export default {
        ...
        created() {
            ...
            Event.$on('view-profile', function(company) {
        ...
        methods: {
            ...
            editUser:async function(event) {
              ...
              /*    try {
                    ...
                    if(this.upload_image){
                       await this.generatePresignedUrl(this.avatar_file, 'company-images/');
            ...
            onFileChange(event) {
                    ...
                    this.company_logo_input_label = this.avatar_file.name;
