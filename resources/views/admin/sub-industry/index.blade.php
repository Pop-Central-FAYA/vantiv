        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 heading-main">
                    <h1>All Sub Industries</h1>
                    <ul>
                        <li><a href="{{ route('dashboard') }}"><i class="fa fa-th-large"></i>Dashboard</a></li>
                        <li><a href="#">All Sub Industries</a></li>
                    </ul>
                </div>
            </div>

            <div class="row">
                <a href="{{ route('sub_industry.create') }}" class="btn btn-success btn-lg">Add New Sub Industry</a>
            </div>
            <p><br></p>
                    ...
                    <div class="nav-tabs-custom">
                        <div class="tab-content">
                            <div class="active tab-pane" id="all">
                                ...
                                <div class="box-body">
                                    <table class="table table-bordered table-striped sub-industry">
                                        <thead>
                                            <tr>
                                                <th>S/N</th>
                                                <th>Industry</th>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="{{ route('sub_industry.delete', ['id' => $industry->id]) }}" type="submit"
...
@section('scripts')
    ...
    <script>
        ...
        var DataCampaign = $('.sub-industry').DataTable({
            paging: true,
            serverSide: true,
            processing: true,
            ajax: {
                url: '/industry/sub-industry/get-data',
                data: function (d) {
