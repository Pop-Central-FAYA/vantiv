            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content" style="padding: 5%">
                    <div class="modal-header">
                        ...
                        <p>Target Audience</p><br>
                        <h4>Edit : {{ $target_audience->audience }}</h4>
                    </div>
                    <form action="{{ route('admin.target_audience.update', ['id' => $target_audience->id]) }}" method="post">
                        <div class="modal-body">
                            {{ csrf_field() }}
                            <div class="row">
                                <div class="group">
                                    <input type="text" name="audience" value="{{ $target_audience->audience }}" class="form-control">
                                    <p><br></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-success">Update Target Audience</button>
        ...
        <div class="modal fade delete{{ $target_audience->id }}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content" style="padding: 5%">
                    ...
                    <div class="modal-footer">
                        <a href="{{ route('admin.target_audience.delete', ['id' => $target_audience->id]) }}" class="btn btn-danger">Delete</a>
                        <button class="btn btn-primary" data-dismiss="modal">Cancel</button>
                    </div>
