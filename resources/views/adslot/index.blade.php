                                    ...
                                    <div class="box-body">
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tr>
                                                ...
                                                @endforeach
                                                <td>
                                                    <a href="#" style="font-size: 16px"><span class="label label-warning" data-toggle="modal" data-target=".bs-example1-modal-md" style="cursor: pointer;">  Edit</span></a>
                    ...
                    <div class="modal-dialog modal-md" role="document">
                        <div class="modal-content" style="padding: 7%">
                            ...
                            <form class="selsec" style="margin-left:">
                                {{--@foreach($adslot as $adslots)--}}
                                    @foreach($adslots->rate_card as $rating)
                                        <p align="center"><input type="radio" name="duration" value="sec"> <span style="margin-left: 10px;">{{ ((object)($rating))->time_in_seconds_id }}</span> <span class="sec-amount">{{ ((object)($rating))->price }}</span></p>
                                    @endforeach
