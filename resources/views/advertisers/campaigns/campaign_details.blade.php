...
@section('title')
    <title>Advertiser | Campaign-Details</title>
@stop
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 heading-main">
                    ...
                    <ul>
                        <li><a href="#"><i class="fa fa-th-large"></i>Campaign</a></li>
                        ...
                        <table class="table table-hover">
                            ...
                            @foreach($campaign_details['file_details'] as $file_detail)
                                <tr>
                                    ...
                                    <td>Played</td>
                                    <td>@if($file_detail['file_status'] === 1) File Approved @elseif($file_detail['file_status'] === 2) File Rejected @else Pending @endif</td>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
