...
@section('content')
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 ">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <p><b>Date:</b> {{ $first_session->start_date }} to {{ $first_session->end_date }}  </p>
                                                        </div>
                                                        <div class="col-md-6">
                                                                        ...
                                                                        <table class="table table-hover" style="font-size:16px">
                                                                            ...
                                                                            @foreach($query as $queries)
                                                                                <tr>
                                                                                    ...
                                                                                    <td><a data-toggle="modal" data-target=".{{ $queries->adslot_id }}delete" class="btn btn-danger btn-xs" style="font-size: 16px"> <i class="fa fa-trash-o" aria-hidden="true"></i> Remove</a></td>

                                                                                </tr>
                                                                            @endforeach
                                                                        </table>
                                                                        <h3 align="" style="padding:2%">&#8358;{{ number_format($calc[0]->total_price, 2) }}</h3>
                                                                    </div>
                                                                    <!-- /.box-body -->
                                                                </div>
                                                            </div>
                            ...
                            <div class="modal fade bs-example2-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content" style="padding: 5%">
                                        ...
                                        Choose payment plab:
                                        <form method="POST" action="{{ route('advertiser_submit.campaign', ['id' => $id, 'broadcaster' => $broadcaster]) }}">
                                            {{ csrf_field() }}
    ...
    @foreach($query as $queries)
        <div class="modal fade {{ $queries->adslot_id }}delete" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content" style="padding: 5%">
                    <p>Are you sure you want to delete this campaign from checkout?</p>
                    <br>
                    <a class="btn btn-danger btn-xs" href="{{ route('agency_cart.remove', ['id' => $queries->adslot_id]) }}">Yes</a> <button class="btn btn-primary btn-xs" data-dismiss="modal">Cancel</button>
                </div>
            </div>
        </div>
    @endforeach
