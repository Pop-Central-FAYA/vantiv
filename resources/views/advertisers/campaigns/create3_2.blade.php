        ...
        <div class="container">
            ...
            <div class="row">
                <div class="Create-campaign">
                    ...
                    <div class="col-md-3 ">
                        <form class="campform dropzone" id="upload1"  method="POST" action="{{ route('advertiser_campaign.store3_2', ['id' => $id, 'broadcaster' => $broadcaster]) }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                        </form>
...
@section('scripts')
    ...
    <script>
        Dropzone.options.upload1 = {
            ...
            init: function() {
                this.on("queuecomplete", function(file, serverresponse) { window.location.href="/advertiser/campaigns/campaign/step3/3/"+"<?php echo $id ?>"+"/"+"<?php echo $broadcaster ?>"; });
            }
        };
    </script>
    <script>
