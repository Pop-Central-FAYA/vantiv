        ...
        <div class="container">
            <div class="row">
                <div class="col-12 heading-main">
                    <h1>Adslots</h1>
                    <ul>
                        <li><a href="{{ route('advertiser.campaign.all') }}"><i class="fa fa-edit"></i>Campaigns</a></li>
                                                ...
                                                <div class="modal modal_container fade bs-example-modal-lg{{ $rating->id }}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
                                                    <div class="modal-dialog modal-lg" role="document">
                                                        <div id="modal_con" class="modal-content" style="padding: 5%">
                                                            ...
                                                            <form id="form_cart" action="{{ route('advertiser_campaign.cart') }}" method="GET">
                                                                {{ csrf_field() }}
            ...
            <div class="row" id="cart_item">
                @if(count($cart) != 0)
                    <a class="btn btn-success btn-lg pull-right" href="{{ route('advertiser_campaign.checkout', ['id' => $id]) }}"><i class="fa fa-shopping-cart"></i>{{ count($cart) }} Cart</a>
                @endif
            </div>
        </div>
