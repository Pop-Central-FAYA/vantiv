        ...
        <div class="container">
            <div class="row">
                <div class="col-12 heading-main">
                    <h1>Advertiser | Campaigns - Report</h1>
                    <ul>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <div class="input-group date styledate">
                                                            ...
                                                            <input type="text" placeholder="start-date" value="" required
                                                                   name="txtFromDate_camp" class="form-control flatpickr txtFromDate"
                                                                   id="txtFromDate"/>
                                                        </div>
                                                    </div>
                                                    <br>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="input-group date styledate">
                                                            ...
                                                            <input type="text" placeholder="stop-date" value="" required
                                                                   name="txtToDate_camp" class="form-control flatpickr txtToDate"
                                                                   id="txtToDate"/>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <div class="input-group" style="">
                                                            <button type="button" class="btn btn-success" id="button_campaign"
                                                                    style="float:left">Apply
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="box"    >
                                            <div class="box-body c_r">
                                                <div class="table-responsive">
                                                    <table class="table table-bordered advertiser_campaign_report">
                                                        <thead>
                                                        <th>S/N</th>
                                                        <th>Campaign Name</th>
                                                        <th>Start</th>
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="input-group date styledate">
                                                        ...
                                                        <input type="text" placeholder="start-date" value="" required
                                                               name="txtFromDate_rev" class="form-control flatpickr txtFromDate"
                                                               id="txtFromDate"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="input-group date styledate">
                                                        ...
                                                        <input type="text" placeholder="stop-date" value="" required
                                                               name="txtToDate_rev" class="form-control flatpickr txtToDate"
                                                               id="txtToDate"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="input-group" style="">
                                                        <button type="button" class="btn btn-success" id="button_rev"
                                                                style="float:left">Apply
                                                        </button>
                                                    </div>
                                                </div>
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="box">
                                            <div class="box-body">
                                                <div class="table-responsive">
                                                    <table class="table table-bordered advertiser_revenue_report">
                                                        <thead>
                                                        <th>S/N</th>
                                                        <th>Date</th>
                                                        <th>Campaign Name</th>
...
@section('scripts')
    ...
    <script>
        $(document).ready(function(){
            ...
            var DatefilterCampaign =  $('.advertiser_campaign_report').DataTable({
                paging: true,
                serverSide: true,
                processing: true,
                ajax: {
                    url: '/advertiser/reports/campaign/all-data',
                    data: function (d) {
            ...
            var DatefilterRevenue =  $('.advertiser_revenue_report').DataTable({
                paging: true,
                serverSide: true,
                processing: true,
                ajax: {
                    url: '/advertiser/reports/revenue/all-data',
                    data: function (d) {
