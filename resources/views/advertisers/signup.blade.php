...
@section('title', trans('app.advertiser-signup'))
    ...
    <div class="div col-md-8 col-md-offset-2">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">Advertiser Signup</h3>
            </div>
            <div class="panel-body">

                <form method="POST" action="{{ route('advertiser.signup') }}" enctype="multipart/form-data" data-parsley-validate="">
