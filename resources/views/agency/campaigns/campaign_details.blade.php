            ...
            <div class="clearfix client_personal campaign_filter">
                ...
                <div class="column col_3">
                    ...
                    <select name="department" id="department">
                        <option value="{{ $campaign_details['campaign_det']['channel_id'] }}">{{ $campaign_details['campaign_det']['channel'] }}</option>
                    </select>
            ...
            <div class="tab_contain">
                ...
                <div class="tab_content col_10 campaign_summary" id="summary">
                    ...
                    <div class="clearfix mb">
                        ...
                        <div class="column col_4">
                            ...
                            <p class="weight_medium">{{ $campaign_details['campaign_det']['channel'] }}</p>
                        </div>
                    </div>
                    ...
                    <div class="clearfix mb">
                        ...
                        <div class="column col_4">
                            ...
                            <div>
                                <p class="weight_medium"><span class="small_faint">Location</span> - {{ $campaign_details['campaign_det']['location'] }}</p>
                                <p class="weight_medium"><span class="small_faint">Audience</span> - Male, Female</p>
                ...
                <div class="tab_content" id="comp">
                    ...
                    <table>
                        ...
                        @foreach($campaign_details['file_details'] as $file_detail)
                            <tr>
                                <td>{{ $campaign_details['campaign_det']['channel'] }}</td>
                                <td>
