                ...
                <div class="media_houses mb3 clearfix">
                    ...
                    @foreach($adslot_search_results as $adslot_search_result)
                        <div class='align_center one_media broad_click'>
                            ...
                            <div><a href="{{ route('agency_campaign.step4', ['id' => $id, 'broadcaster' => $adslot_search_result['broadcaster']]) }}"><img src="{{ asset($adslot_search_result['logo'] ? decrypt($adslot_search_result['logo']) : '') }}"></a></div>
