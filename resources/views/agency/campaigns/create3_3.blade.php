        ...
        <div class="container">
            ...
            <div class="row">
                <div class="Create-campaign">
                    ...
                    <div class="col-md-3 ">
                        <form class="campform dropzone" id="upload1"  method="POST" action="{{ route('agency_campaign.store3_3', ['id' => $id, 'broadcaster' => $broadcaster]) }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                        </form>
...
@section('scripts')
    ...
    <script>
        Dropzone.options.upload1 = {
            ...
            init: function() {
                this.on("queuecomplete", function(file, serverresponse) { window.location.href="/agency/campaigns/review-uploads/"+"<?php echo $id ?>"+"/"+"<?php echo $broadcaster ?>"; });
            }
        };
    </script>
@stop
