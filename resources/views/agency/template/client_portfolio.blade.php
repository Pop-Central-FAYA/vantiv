...
@section('title')
    <title>Agency | Client-Portfolio</title>
@stop
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb" style="font-size: 16px">
            ...
            <li><a href="client-portfolio.html"><i class="fa fa-address-card"></i> Client Portfolio</a> </li>
                            ...
                            <div class="box-body">
                                <table id="example1" class="table table-bordered table-striped" style="font-size: 16px">
                                    ...
                                    <tr>
                                        ...
                                        <th>Dated Date</th>
                                        <th>Create by</th>
                                        <th>Total Expenses till date</th>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="client-portfolio-details.html">
                                                <p>
                                                    <img src="{{ asset('agency_asset/dist/img/flickr.png') }}" width="20%">
                                                </p>
                                            </a>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="client-portfolio-details.html">
                                                <p>
                                                    <img src="{{ asset('agency_asset/dist/img/coke.png') }}" width="20%">
                                                </p>
                                            </a>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="client-portfolio-details.html">
                                                <p>
                                                    <img src="{{ asset('agency_asset/dist/img/nike.png') }}" width="20%">
                                                </p>
                                            </a>
                                        </td>
                                        <td>27 September 2015</td>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="client-portfolio-details.html">
                                                <p>
                                                    <img src="{{ asset('agency_asset/dist/img/pepsi.png') }}" width="20%">
                                                </p>
                                            </a>
                                        </td>
                                        <td>27 September 2015</td>
