                                ...
                                <table id="example1" class="table table-bordered table-striped" style="font-size: 16px">
                                    ...
                                    <tr>
                                        <td>
                                            <a href="client-portfolio-details-more.html">
                                                <p>
                                                    <img src="{{ asset('agency_asset/dist/img/googledrive.png') }}" width="20%">
                                                </p>
                                            </a>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="client-portfolio-details-more.html">
                                                <p>
                                                    <img src="{{ asset('agency_asset/dist/img/gmail.png') }}" width="20%">
                                                </p>
                                            </a>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="client-portfolio-details-more.html">
                                                <p>
                                                    <img src="{{ asset('agency_asset/dist/img/googleplay.png') }}" width="20%">
                                                </p>
                                            </a>
