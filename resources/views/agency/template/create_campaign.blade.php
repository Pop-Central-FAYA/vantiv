...
@section('title')
    <title>Agency | Campaign Form</title>
@stop
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb" style="font-size: 16px">
            ...
            <li><a href="index.html"><i class="fa fa-address-card"></i>   Create Campaign
                </a> </li>
            ...
            <div class="row" style="padding: 5%">
                <div class="col-xs-12">
                    ...
                    <p align="center" style="font-size: 17px;">
                        The history of advertising can be traced to ancient civilizations. <br />  It became a major force in capitalist economies in the mid-19th century, based primarily on newspapers and magazines.<br />  In the 20th century, advertising grew rapidly with new technologies such as direct mail, radio, television, the internet and mobile devices.</p>
                    <div class="box">
                        ...
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    <td>Media File</td>
                                    <td><i class="fa fa-video-camera" aria-hidden="true"></i> Tech.mpeg</td>
                                    <td>60 seconds</td>


                                    <td><a href="#"style="font-size: 16px"><i class="fa fa-trash"></i> Remove</a></td>
                                </tr>
                            ...
                            <form style="margin-top:5%; font-size: 16px">
                                <div class="col-md-6">
                                    <input type="file" name="">
                                </div>
                                <div class="col-md-6">
                                    <select style="width: 60%; padding: 1%; background: #eee">
