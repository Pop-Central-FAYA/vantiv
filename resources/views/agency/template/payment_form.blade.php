...
@section('title')
    <title>Agency | Payment Wallet Form</title>
@stop
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb" style="font-size: 16px">
            ...
            <li><a href="paymentform.html"><i class="fa fa-address-card"></i> Payment Form</a> </li>
                    ...
                    <div class="col-md-6">
                        <form class="add-disc2">
                            ...
                            <p>
                                ...
                                <input type="text" name="" placeholder="MM/YY" style="width: 50%">
                            </p>
                            ...
                            <p>
                                <button type="submit" class="btn btn-large btn-danger">Make Payment</button>
                            </p>
                        </form>
                    </div>
                    <div class="col-md-3 hidden-sm hidden-xs"></div>
