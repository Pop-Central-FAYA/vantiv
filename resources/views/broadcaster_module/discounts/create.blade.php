...
@section('title')
    <title>Torch | Create Discount</title>
@stop
    ...
    <div class="main_contain">
        ...
        <div class="sub_header clearfix mb pt">
            <div class="column col_6">
                <h2 class="sub_header">Create Discount</h2>
            </div>
        </div>
            ...
            <form action="{{ route('discount.store') }}" method="post">
                ...
                <div class="margin_center col_11 clearfix pt4 create_fields">
                    ...
                    <div class="clearfix mb3">
                        <div class="input_wrap column col_4 {{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="">
                                <input type="text" name="name" required placeholder="Discount Name">
                    ...
                    <div class="clearfix mb3">
                        <div class="input_wrap column col_4 {{ $errors->has('percentage') ? ' has-error' : '' }}">
                            ...
                            <div class="">
                                <input type="text" name="percentage" required placeholder="Discount Percentage">
                ...
                <!-- end -->
                    ...
                    <div class="mb4 align_right pt">
                        <input type="submit" value="Create Discount" class="btn uppercased mb4">
                    </div>
