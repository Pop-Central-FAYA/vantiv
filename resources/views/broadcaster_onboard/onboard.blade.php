...
@section('title', trans('Onboard Broadcaster'))
    ...
    <div class="div col-md-8 col-md-offset-2">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">OnBoard Broadcaster</h3>
            </div>
            <div class="panel-body">

                <form method="POST" action="{{ route('broadcaster.signup') }}" enctype="multipart/form-data" data-parsley-validate="">
                    ...
                    <div class="row col-md-12">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                @if ($errors->has('sector_id')) <p class="help-block" style="color: red">{{ $errors->first('sector_id') }}</p> @endif
                            </div>
                        </div>
                    </div>
