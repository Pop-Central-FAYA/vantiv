    ...
    <div class="main-section">
        <div class="container">
            <div class="row">
                ...
                <div class="Add-brand">
                    <form class="campform" method="POST" action="{{ route('broadcaster.user.campaign.store2', ['walkins' => $walkins, 'broadcaster' => $broadcaster, 'broadcaster_user' => $broadcaster_user]) }}">
                        {{ csrf_field() }}
                        @if(count($adslots) === 0)
                ...
                <script>
                    $(document).ready(function() {
                        ...
                        $('#step2').click(function(){
                            window.location.href = '/broadcaster-user/campaign/create/'+user_id+'/'+broadcaster+'/'+broadcaster_user+'/step1';
                        });
                    });
                </script>
