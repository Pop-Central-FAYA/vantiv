        ...
        <div class="container">
            <div class="row">
                <div class="col-12 heading-main">
                    <h1>Broadcaster User Report</h1>
                    <ul>
                        <li><a href="#"><i class="fa fa-edit"></i>Broadcaster User</a></li>
                                                ...
                                                <form action="#" method="GET" class="form-inline" style="text-align: center;margin: 20px auto;">
                                                    ...
                                                    <div class="col-md-10" style="margin-top: 10px">
                                                        <div class="input-group date styledate" style="width:30% !important">
                                                            ...
                                                            <input type="text" name="txtFromDate_hpd" placeholder="Start Date" class="flatpickr form-control pull-right txtFromDate" id="txtFromDate_ps">
                                                        </div>
                                                        ...
                                                        <div class="input-group date styledate" style="width:30% !important">
                                                            ...
                                                            <input type="text" name="txtToDate_hpd" placeholder="End Date" class="flatpickr form-control pull-right txtToDate" id="txtToDate_ps" >
                                                        </div>
                                                        <div class="input-group" style="">
                                                            <input type="button" class="btn btn-primary search-btn" id="button_hpd" value="Apply" style="float:left" >
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
                                                ...
                                                <form action="#" method="GET" class="form-inline" style="text-align: center;margin: 20px auto;">
                                                    ...
                                                    <div class="col-md-10" style="margin-top: 10px">
                                                        <div class="input-group date styledate" style="width:30% !important">
                                                            ...
                                                            <input type="text" name="txtFromDate_hpdays" placeholder="Start Date" class="flatpickr form-control pull-right txtFromDate" id="txtFromDate_ps">
                                                        </div>
                                                        ...
                                                        <div class="input-group date styledate" style="width:30% !important">
                                                            ...
                                                            <input type="text" name="txtToDate_hpdays" placeholder="End Date" class="flatpickr form-control pull-right txtToDate" id="txtToDate_ps" >
                                                        </div>
                                                        <div class="input-group" style="">
                                                            <input type="button" class="btn btn-primary search-btn" id="button_hpdays" value="Apply" style="float:left" >
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
                                                    ...
                                                    <form action="#" method="GET" class="form-inline" style="text-align: center;margin: 20px auto;">
                                                        ...
                                                        <div class="col-md-10" style="margin-top: 10px">
                                                            <div class="input-group date styledate" style="width:30% !important">
                                                                ...
                                                                <input type="text" name="txtFromDate_hvc" placeholder="Start Date" class="flatpickr form-control pull-right txtFromDate" id="txtFromDate_ps">
                                                            </div>
                                                            ...
                                                            <div class="input-group date styledate" style="width:30% !important">
                                                                ...
                                                                <input type="text" name="txtToDate_hvc" placeholder="End Date" class="flatpickr form-control pull-right txtToDate" id="txtToDate_ps" >
                                                            </div>
                                                            <div class="input-group" style="">
                                                                <input type="button" class="btn btn-primary search-btn" id="button_hvc" value="Apply" style="float:left" >
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
                                                    ...
                                                    <form action="#" method="GET" class="form-inline" style="text-align: center;margin: 20px auto;">
                                                        ...
                                                        <div class="col-md-10" style="margin-top: 10px">
                                                            <div class="input-group date styledate" style="width:30% !important">
                                                                ...
                                                                <input type="text" name="txtFromDate_tvc" placeholder="Start Date" class="flatpickr form-control pull-right txtFromDate" id="txtFromDate_ps">
                                                            </div>
                                                            ...
                                                            <div class="input-group date styledate" style="width:30% !important">
                                                                ...
                                                                <input type="text" name="txtToDate_tvc" placeholder="End Date" class="flatpickr form-control pull-right txtToDate" id="txtToDate_ps" >
                                                            </div>
                                                            <div class="input-group" style="">
                                                                <input type="button" class="btn btn-primary search-btn" id="button_tvc" value="Apply" style="float:left" >
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
                                                ...
                                                <form action="#" method="GET" class="form-inline" style="text-align: center;margin: 20px auto;">
                                                    ...
                                                    <div class="col-md-10" style="margin-top: 10px">
                                                        <div class="input-group date styledate" style="width:30% !important">
                                                            ...
                                                            <input type="text" name="txtFromDate_pi" placeholder="Start Date" class="flatpickr form-control pull-right txtFromDate" id="txtFromDate_ps">
                                                        </div>
                                                        ...
                                                        <div class="input-group date styledate" style="width:30% !important">
                                                            ...
                                                            <input type="text" name="txtToDate_pi" placeholder="End Date" class="flatpickr form-control pull-right txtToDate" id="txtToDate_ps" >
                                                        </div>
                                                        <div class="input-group" style="">
                                                            <input type="button" class="btn btn-primary search-btn" id="button_pi" value="Apply" style="float:left" >
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            var Datefilter =  $('.hvc-table').DataTable({
                ...
                processing: true,
                ajax: {
                    url: '/broadcaster-user/reports/total-volume-campaigns/all-data/',
                    data: function (d) {
            ...
            var DateFilterPI =  $('#pi-table').DataTable({
                ...
                processing: true,
                ajax: {
                    url: '/broadcaster-user/reports/paid-invoices/all-data',
                    data: function (d) {
            ...
            var DateFilterPS = $('#ps-table').DataTable({
                ...
                processing: true,
                ajax: {
                    url: '/broadcaster-user/reports/periodic-sales/all',
                    data: function (d) {
            ...
            var DateFilterTvc = $('#tvc-table').DataTable({
                ...
                processing: true,
                ajax: {
                    url: '/broadcaster-user/reports/total-volume-of-campaign/all',
                    data: function (d) {
            ...
            var DateFilterHpd = $('#hpd-table').DataTable({
                ...
                processing: true,
                ajax: {
                    url: '/broadcaster-user/reports/high-day-parts/all',
                    data: function (d) {
            ...
            var DateFilterHpdays = $('#hpdays-table').DataTable({
                ...
                processing: true,
                ajax: {
                    url: '/broadcaster-user/reports/high-days/all',
                    data: function (d) {
