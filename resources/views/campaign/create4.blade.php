        ...
        <div class="container">
            ...
            <div class="row">
                <div class="Create-campaign">
                    ...
                    <div class="col-md-3 ">
                        <form class="campform dropzone" id="upload1"  method="POST" action="{{ route('campaign.store4', ['walkins' => $walkins]) }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                        </form>
...
@section('scripts')
    ...
    <script>
        Dropzone.options.upload1 = {
            ...
            init: function() {
                this.on("queuecomplete", function(file, serverresponse) { window.location.href="/campaign/create/"+"<?php echo $walkins; ?>"+"/step4/1"; });
            }
        };
    </script>
    <script>
