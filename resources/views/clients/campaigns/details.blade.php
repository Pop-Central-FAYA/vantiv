...
@section('title')
    <title>Clients - Campaign-Details</title>
@stop
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 heading-main">
                    ...
                    <ul>
                        <li><a href="{{ route('client.campaign.all') }}"><i class="fa fa-th-large"></i>Client Campaign</a></li>
            ...
            <div class="row">
                <div class="col-md-10">
                    ...
                    <p><h4>Brand: {{ ucfirst($campaign_details['campaign_det']['brand']) }}</h4></p><br>
