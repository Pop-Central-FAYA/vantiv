...
@stop
@section('body_info')
<td align="center" style="padding:0;Margin:0;"> <h4 style="Margin:0;line-height:24px;font-family:tahoma, verdana, segoe, sans-serif;font-size:20px;font-style:normal;font-weight:normal;color:#333333;">Notification</h4> </td> 
    </tr> 
   ...
   <br></p> </td> 
    ...
    <tr style="border-collapse:collapse;"> 
    <td align="center" style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px;"> <p style="Margin:0;font-size:14px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;">The media plan for {!! $mail_content['client'] !!} that you sent for approval has been {!! $mail_content['action'] !!} by {!! $mail_content['sender_name'] !!}<br></p> </td> 
    </tr> 
    <tr style="border-collapse:collapse;"> 
