<div id="sidebar" class="left-area">
    <div class="sidebar-header">
        ...
        <ul class="list-unstyled components">
            ...
            <li class="{{ Request::is('broadcaster-user/campaign/all-campaigns') ? 'active' : ''  }}"> <a href="{{ route('broadcaster.user.campaign.all') }}"><i class="fa fa-rocket"></i><span>Campaigns</span></a></li>
