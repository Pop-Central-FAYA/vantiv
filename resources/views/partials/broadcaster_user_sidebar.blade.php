<div id="sidebar" class="left-area">
    <div class="sidebar-header">
        ...
        <ul class="list-unstyled components">
            ...
            {{--<li class="{{ Request::is('broadcaster-user/campaign/all-campaigns') ? 'active' : Request::is('broadcaster-user/campaign/campaign-details/*') ? 'active' : ''  }}"> <a href="{{ route('broadcaster.user.campaign.all') }}"><i class="fa fa-rocket"></i><span>Campaigns</span></a></li>--}}
            <li class="{{ Request::is('broadcaster-user/campaign/all-campaigns') ? 'active' : Request::is('broadcaster-user/campaign/campaign-details/*') ? 'active' : ''  }}"><a href="{{ route('broadcaster.user.campaign.all') }}"><i class="fa fa-rocket"></i><span>Campaigns</span></a>
                <ul class="sub-menu dropdown">
                    <li><a href="{{ route('broadcaster_user.campaign.setup') }}"><i class="fa fa-address-card-o"></i> <span>Create <br /> Campaign</span></a></li>
                    <li><a href="{{ route('broadcaster.user.campaign.all') }}"><i class="fa fa-address-book-o"></i><span>All <br /> Campaigns</span></a></li>
                </ul>
            </li>
