<div id="sidebar" class="left-area">
    <div class="sidebar-header">
        ...
        <ul class="list-unstyled components">
            ...
            <li class="{{ Request::is('agency/campaigns/*') ? 'active' : ''  }}"> <a href="#"><i class="fa fa-rocket"></i><span>Campaign Management</span> </a>
            ...
            <li class="{{ Request::is('agency/clients/*') ? 'active' : ''  }}"> <a href="#"><i class="fa fa-user-plus"></i><span>Clients</span></a>
                <ul class="sub-menu dropdown">
            ...
            <li class="{{ Request::is('agency/invoices/*') ? 'active' : ''  }}"> <a href="#" ><i class="fa fa-volume-down"></i><span>Invoice</span></a>
                <ul class="sub-menu dropdown">
            ...
            <li class="{{ Request::is('agency/wallets/*') ? 'active' : ''  }}"> <a href="#"><i class="fa fa-briefcase"></i><span>Wallet</span></a>
                <ul class="sub-menu dropdown">
