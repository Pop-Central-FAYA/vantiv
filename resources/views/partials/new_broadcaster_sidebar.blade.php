<div id="sidebar" class="left-area">
    <div class="sidebar-header">
        ...
        <ul class="list-unstyled components">
            ...
            <li class="{{ Request::is('broadcaster/users') ? 'active' : Request::is('') || Request::is('broadcaster/users/create') ? 'active' : ''  }}"> <a href="{{ route('broadcaster.user.all') }}" ><i class="fa fa-user"></i><span>User Management</span></a>
                <ul class="sub-menu dropdown">
                    <li><a href="{{ route('broadcaster.user.all') }}"><i class="fa fa-address-card-o"></i> <span>User <br /> List</span></a></li>
                    <li><a href="{{ route('broadcaster.user.create') }}"><i class="fa fa-address-book-o"></i><span>Add<br /> User</span></a></li>
                </ul>
            </li>
