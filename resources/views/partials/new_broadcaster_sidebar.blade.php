<div id="sidebar" class="left-area">
    <div class="sidebar-header">
        ...
        <ul class="list-unstyled components">
            ...
            <li class="{{ Request::is('brands/*') ? 'active' : ''  }}"> <a href="{{ route('brand.all') }}"><i class="fa fa-th-large"></i><span>Brands Management</span></a>
                <ul class="sub-menu dropdown">
            ...
            <li class="{{ Request::is('walkins/*') ? 'active' : ''  }}"> <a href="{{ route('walkins.all') }}" ><i class="fa fa-volume-down"></i><span>Walkins</span></a>
                <ul class="sub-menu dropdown">
            ...
            <li class="{{ Request::is('adslot/*') || Request::is('discount') ? 'active' : ''  }}"> <a href="{{ route('adslot.all')  }}" ><i class="fa fa-volume-down"></i><span>Ads Management</span></a>
                <ul class="sub-menu dropdown">
