...
Route::group(['domain' => 'stage.vantage'. $_SERVER['SERVER_NAME']], function() {
   ...
   Route::group(['prefix' => 'reports'], function(){
       ...
       Route::get('/campaign/all-data', 'ReportsController@getCampaign');
       Route::get('/revenue/all-data', 'ReportsController@getRevenue');
//      Route::get('/client-filter/campaign', 'ReportsController@filterCampaignClient')->name('filter.client');
   });
