    ...
    Route::group(['middleware' => 'token'], function () {
        ...
        */
        Route::group(['prefix' => 'campaign'], function(){
            ...
            Route::get('/create/{id}/{audience}/step4', 'CampaignsController@createStep4')->name('campaign.create4');
            Route::get('/create/{id}/{audience}/step5', 'CampaignsController@createStep5')->name('campaign.create5');
            Route::get('/create/{id}/{audience}/step6', 'CampaignsController@createStep6')->name('campaign.create6');
            Route::get('/create/{id}/{audience}/step7', 'CampaignsController@createStep7')->name('campaign.create7');
            ...
            Route::post('/create/{id}/{audience}/step4/store', 'CampaignsController@postStep4')->name('campaign.store4');
            Route::post('/create/{id}/{audience}/step5/store', 'CampaignsController@postStep5')->name('campaign.store5');
            Route::post('/create/{id}/{audience}/step6/store', 'CampaignsController@postStep6')->name('campaign.store6');
            Route::get('/create/{id}/{audience}/step7/get', 'CampaignsController@getStep7')->name('campaign.store7');
            Route::post('/store', 'CampaignsController@store')->name('campaign.store');
            Route::post('/add-to-cart/{audience}', 'CampaignsController@postCart')->name('store.cart');
