<?php
Route::group(['namespace' => 'Ssp'], function () {
    ...
    Route::group(['namespace' => 'Auth'], function() {
        ...
        Route::post('/change-password/process/{user_id}', 'AuthController@processChangePassword')
                ->name('change_password.process');
        Route::get('register/verify/{token}', 'AuthController@verifyToken');
    });
    Route::get('user/complete-account/{id}', 'UserController@getCompleteAccount')
            ->name('user.complete_registration')->middleware('signed');
    ...
    Route::group(['middleware' => 'auth'], function () {
        ...
        Route::post('/profile/details/update', 'ProfileManagementsController@updateDetails')
                    ->name('profile.update.details')->middleware('permission:update.profile');
        /**
         * User Route
         */
        ...
        */
        ...
        Route::get('/inventory-management/reports', 'DashboardController@getFilteredInventoryReports')
                ->name('broadcaster.inventory_management.timebelts_report');
        ...
        */
        ...
        Route::group(['prefix' => 'campaign'], function() {
            ...
            Route::get('/compliance-graph/filter/broadcaster', 'CampaignsController@complianceFilter')
                        ->name('broadcaster.campaign_details.compliance');
            Route::post('/update-campaign/information/{campaign_id}', 'CampaignsController@updateCampaignInformation')
                        ->name('broadcaster.campaign_information.update');
        });

        Route::group(['namespace' => 'Compliance'], function() {
            Route::get('/compliance/view-summary/{campaign_id}', 'Compliance\ComplianceController@downloadSummary')
                        ->name('compliance.download.summary');
            Route::get('/compliance/view-summary/{campaign_id}', 'Compliance\ComplianceController@downloadSummary')
                        ->name('compliance.download.summary');
        });
    });
