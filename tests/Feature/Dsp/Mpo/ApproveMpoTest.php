...
class ApproveMpoTest extends MpoTestCase
{
    protected $route_name = 'mpos.approve_mpo';
    ...
    public function test_user_without_the_right_permission_cannot_approve_an_mpo()
    {
    ...
    public function test_it_can_only_approve_mpo_whoose_status_is_in_review()
    {
        ...
        $this->assertEquals(MpoStatus::APPROVED, $expected['mpo_details']['status']);
    }

    public function test_it_does_not_approve_mpo_with_status_other_than_in_review()
    {
        $company = factory(Company::class)->create([
            'parent_company_id' => factory(ParentCompany::class)->create()->id
        ]);
